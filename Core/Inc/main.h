...
/* Private defines -----------------------------------------------------------*/
#define GPS_SCL_Pin GPIO_PIN_7
#define GPS_SCL_GPIO_Port GPIOB
#define GPS_SDA_Pin GPIO_PIN_14
#define GPS_SDA_GPIO_Port GPIOC
#define LNA_EN_Pin GPIO_PIN_2
#define LNA_EN_GPIO_Port GPIOF
...
#define RADIO_RX_Pin GPIO_PIN_13
#define RADIO_RX_GPIO_Port GPIOA
#define RADIO_TX_Pin GPIO_PIN_14
