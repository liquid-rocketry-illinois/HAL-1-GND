...
void PeriphCommonClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInit.HSIKerClockDivider = RCC_HSIKER_DIV5;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, USR_LED_Pin|RADIO_M0_Pin|RADIO_M1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : USR_LED_Pin RADIO_M0_Pin RADIO_M1_Pin */
  GPIO_InitStruct.Pin = USR_LED_Pin|RADIO_M0_Pin|RADIO_M1_Pin;
  ...
  /*Configure GPIO pin : BTN_ABORT_Pin */
  GPIO_InitStruct.Pin = BTN_ABORT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BTN_ABORT_GPIO_Port, &GPIO_InitStruct);
